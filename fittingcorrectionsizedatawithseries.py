# -*- coding: utf-8 -*-
"""
Created on Thu Oct  1 23:02:58 2020

@author: Leigh Fair-Smiley

Description:
    X = How negative a bear run is, Y = how positive a bull run is. output is a fitted line that predicts one given the other.
"""
...
#deviation2 = 0ok   k
for val in x:
    deviation += abs(y[xIndex] - func(x[xIndex], *popt))
...
deviation: 0.006503784325284841
"""